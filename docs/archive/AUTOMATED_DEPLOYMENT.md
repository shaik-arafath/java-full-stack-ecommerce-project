...
1. Every time you push code to the `main` branch of your GitHub repository, GitHub Actions automatically:
   ...
   - Deploys to your VPS at YOUR_SERVER_IP
...
4. Your site will be live at https://your-domain.example within a few minutes
...
Access the Traefik dashboard at: http://YOUR_SERVER_IP:8080
...
With this system, every time you push code to your main branch, your website at https://your-domain.example will automatically update with zero manual steps required.