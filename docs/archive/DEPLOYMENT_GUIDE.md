...
2. A VPS at YOUR_SERVER_IP with Docker, Docker Compose, and Coolify already installed
3. Your domain (your-domain.example) pointed to your VPS IP
...
# Or manually add it:
# cat ~/.ssh/github-actions.pub | ssh root@YOUR_SERVER_IP "mkdir -p ~/.ssh && cat >> ~/.ssh/authorized_keys"
```
...
5. Configure your domain (your-domain.example) in Coolify
...
3. Visit https://your-domain.example to see your updated app
...
- Check that DNS records point to YOUR_SERVER_IP
...
This setup ensures that every time you push code to the main branch of your repository, your application at https://your-domain.example is automatically updated with zero manual steps required.