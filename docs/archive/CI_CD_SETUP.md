...
This guide will help you set up automated deployment for your Java full-stack project to your VPS at YOUR_SERVER_IP.

## Prerequisites

1. A GitHub repository with your project code
2. A VPS with Docker and Docker Compose installed
3. A domain name (your-domain.example) with DNS properly configured
...
- An A record for `your-domain.example` pointing to `YOUR_SERVER_IP`
- An A record for `www.your-domain.example` pointing to `YOUR_SERVER_IP`
...
- http://YOUR_SERVER_IP (direct IP)
- https://your-domain.example (domain with SSL)
