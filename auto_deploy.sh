...
sshpass -e scp -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null -r "$DEPLOY_DIR"/* root@YOUR_SERVER_IP:/tmp/umat
...
sshpass -e ssh -o StrictHostKeyChecking=no -o UserKnownHostsFile=/dev/null root@YOUR_SERVER_IP 'bash /tmp/umat/deploy_remote.sh'
