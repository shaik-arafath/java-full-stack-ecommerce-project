...
echo mkdir -p /var/www/your-domain.example >> deploy_simple.sh
echo mkdir -p /opt/rawfade >> deploy_simple.sh
echo cp -r * /var/www/your-domain.example/ >> deploy_simple.sh
echo cp spring_backend/target/*.jar /opt/rawfade/app.jar >> deploy_simple.sh
echo rm -rf /var/www/your-domain.example/spring_backend >> deploy_simple.sh
echo rm /var/www/your-domain.example/simple_deploy.bat >> deploy_simple.sh
echo rm /var/www/your-domain.example/deploy_simple.sh >> deploy_simple.sh
echo cp /var/www/your-domain.example/nginx.conf /etc/nginx/sites-available/your-domain.example >> deploy_simple.sh
echo ln -sf /etc/nginx/sites-available/your-domain.example /etc/nginx/sites-enabled/ >> deploy_simple.sh
